...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 30, 2019 at 03:08 PM
...
(1, 0, 'Computadores', ''),
(2, 1, 'Computadores desktop', ''),
(3, 1, 'Computadores portáteis', ''),
(4, 0, 'Teclados PC', ''),
(5, 4, 'Teclados Gaming', ''),
(6, 5, 'Teclado XPTO', '');
...
CREATE TABLE `stock_taxas` (
  `id_taxa` int(11) NOT NULL,
  `designacao` varchar(50) NOT NULL,
  `percentagem` decimal(3,2) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
ALTER TABLE `stock_taxas`
  MODIFY `id_taxa` int(11) NOT NULL AUTO_INCREMENT;
